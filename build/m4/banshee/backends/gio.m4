...
[
    ...
    AC_ARG_ENABLE(gio, AC_HELP_STRING([--enable-gio], [Disable GIO for IO operations]), , enable_gio="no")
    AC_ARG_ENABLE(gio_hardware, AC_HELP_STRING([--enable-gio-hardware], [Disable GIO Hardware backend]), , enable_gio_hardware="no")
